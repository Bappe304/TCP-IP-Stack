...
build_first_topo(){
    ...
    insert_link_between_two_nodes(R0_re, R2_re, "eth0/5", "eth0/4", 1);
    ...
    node_set_intf_ip_address(R0_re, "eth0/5", "40.1.1.1", 24);
    ...
    node_set_intf_ip_address(R2_re, "eth0/4", "40.1.1.2", 24);
