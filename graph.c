/*
    Description: This file contains the APIs for constructing nodes, making links between the nodes to construct
                 the network graphs.
*/
...
void insert_link_between_two_nodes(node_t *node1, node_t *node2, char *from_if_name, char *to_if_name, unsigned int cost)
{
	...
	/*Now we assign random generated Mac address to the interface*/
