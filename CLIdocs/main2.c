                               ...
                               op_mode enable_or_disable) /*This is meaningful for config commands*/
{
    ...
    TLV_LOOP_BEGIN(tlv_buf, tlv)
    {
        ...
        else if(strncmp(tlv->leaf_id, "lo_address", strlen("lo_address")) == 0)  /*lo-address is the leaf id*/
        {
...
main(int argc, char **argv){
...

        {
            ...
            init_param(&node_name, /*Pointer(address) to the current param*/
                       ...
                       STRING,                 /*leaf param value type. Node name is string, hence pass STRING
                                                This is the LEAF_TYPE in the tlv structure*/
                       "node-name",            /*Applicable only for LEAF param. Give some name to leaf-params. It is this string that we will parse in application code to find the value passed by the user
                                                This is the LEAF_ID in the tlv structure*/
    ...
    /* Command Tree starts here: Note that all the hooks are siblings */
